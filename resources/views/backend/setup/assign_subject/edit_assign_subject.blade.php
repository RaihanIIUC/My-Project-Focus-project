        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title " style="font-size: xx-large;">Edit Assign Subject</h4>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="class_id" id="select" required class="form-control" disabled>
        ...
        <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <select name="subject_id[]" id="select" required class="form-control">
                            <option value="" disabled>Select Student Class</option>
                            @foreach ($subjects as $subject)
                            <option value="{{ $subject->id }}" {{ ($editData[0]->subject_id == $subject->id ) ? 'selected' : ' '}}>
                                {{ $subject->name }}
                            </option>
                            @endforeach
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <h5>Full Mark<span class="text-danger">*</span></h5>
                    <div class="controls">
                        <input type="text" name="full_mark[]" value="{{  $editData[0]->full_mark }}" class="form-control">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <h5>Pass Mark<span class="text-danger">*</span></h5>
                    <div class="controls">
                        <input type="text" name="pass_mark[]" value="{{  $editData[0]->pass_mark }}" class="form-control">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <h5>Subjective Mark<span class="text-danger">*</span></h5>
                    <div class="controls">
                        <input type="text" name="subjective_mark[]" value="{{  $editData[0]->subjective_mark }}" class="form-control">
